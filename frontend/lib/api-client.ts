...
/**
 * Multipart upload wrapper (profile photo, CV, event banner). Deliberately
 * does NOT set a Content-Type header — the browser needs to set its own
 * multipart boundary, which it can only do if we leave the header alone.
 */
