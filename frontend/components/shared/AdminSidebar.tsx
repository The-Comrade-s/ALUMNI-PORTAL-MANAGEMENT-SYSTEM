...
import {
  ...
  UserCheck, FileBarChart, ScrollText, LogOut,
} from 'lucide-react';
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-line-200 bg-navy-900 md:flex">
      ...
      <div className="border-t border-white/10 px-3 py-4">
        <Link href="/logout" className="flex items-center gap-3 rounded-card px-3 py-2.5 text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white">
