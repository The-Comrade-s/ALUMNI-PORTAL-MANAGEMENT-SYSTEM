...
import {
  ...
  MessageSquare, Newspaper, Gift, Settings, LogOut,
} from 'lucide-react';
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-line-200 bg-white md:flex">
      ...
      <div className="space-y-1 border-t border-line-200 px-3 py-4">
        ...
        <Link href="/logout" className="flex items-center gap-3 rounded-card px-3 py-2.5 text-sm font-medium text-slate-500 hover:bg-mist-100 hover:text-danger">
